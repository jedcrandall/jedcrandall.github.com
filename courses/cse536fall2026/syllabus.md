...
There will be no scheduled exams during the semester.  Pop quizzes (details
below) will take the place of exams.

We will not meet physically for the final exam, but instead there will be a
final summary write-up about all four projects (details below) that is due at
the end of the scheduled exam period:

- Thursday, December 10th, 7:30am to 9:20am
...
office together.  On Mondays and Wednesdays I teach CSE 468 from 9am to
10:15am, you can find the location on my website.

## TA and office hours

There is no TA for the course.  There might be a grader, but as per University
policy students in the course do not interact with the grader.
...
- Students will gain an understanding of filesystems and access controls.
...
- Students will compare different ways of implementing distributed systems.
...
- Conceptual fundamentals, covered in lectures and readings and assessed by pop quizzes.  This is 30% of your grade.
...
up 20% of your grade.
- Four projects and a summary.  Each project is 10% of your grade, as is the summary, for a total of 50% of your grade. 


The percentage for your grade is out of 100% (30% quizzes, 20% hands-on assignments, 50% projects).  Grades are based on the following
...
attendance is expected of all students.  There is no way to make up pop quizzes
without involving the Dean of Students.
...
minute period.  You'll be given at least 5 minutes to answer the question(s)
for the quiz.  You should always bring blank 3" by 5" index cards to class.  I will not accept quizzes on any kind of paper, only index cards. 

The pop quizzes will be closed book and closed notes, and no scratch paper is
allowed.  You can have nothing on your desk except for the index card and a pen
or pencil.  

## Hands-on assignments

There will be 5 to 8 hands-on assignments throughout the semester.  These are
meant to reinforce the lecture and reading materials and/or prepare you for
projects.  They will be moderate in scope.  They will be assigned in Canvas,
and you'll use Canvas to submit them.

## Projects and final write-up
...
Part of each project will be to also participate in debates in Canvas and get
feedback about your implementation from your classmates.  You'll summarize all
of this, along with the four projects themselves, in a short write-up that will
serve as the final product that will be due in lieu of a final during our
scheduled final exam time.  Details will be posted in Canvas.
...
Canvas (private messages or the forum) or come to office hours, unless there is
some compelling reason to use email.  The same is true for course
administrativia (requesting an extension, you need a signature from me for some
reason, etc.)  Feel free to email me any time for anything, I won't shame you,
but in all cases you're much more likely to get a timely response in Canvas
than via email.  If I'm slow to reply in Canvas then pinging me over email
can't hurt.

All digital artifacts assignments should be done in Linux.  If you use other
OSes you do so at your own risk, and with no guarantee of support from me.  If you attempt to do the assignments in Mac OS, it's probably possible
but it's going to be painful and the amount of help I can offer is minimal.
...
you attempt to do the assignments in OSes that don't have a native UNIX-like
...
I recommend keeping your code and other work for this course in a *private* git
repository that you periodically commit to.  (You can use GitHub, but the repo
...
The course is roughly arranged into four areas that correspond with the four projects you'll do throughout the semester.
...
For details and links for the assigned readings, please see the course website. 
...
academic integrity policy.  You will not turn in your source code for some
assignments, but if I suspect cheating I reserve the right to require you to
come to my office and show me your source code to get full points.  Some
assignments are graded automatically by graders with anti-cheating mechanisms
